...
// function to display news title
 function display_news($news_array){
   ...
   echo'<div class="list-card align-items-center marginTop-30">
   <div class="col-md-4 px-md-0">
     <img class="w-100" src="assets/img/262x230/1.jpg" alt="">
   </div>
   <div class="col-md-8 p-4">
     <p class="text-primary">'.$row['date'].'</p>';
...
<div class="col-xs-12 admin_header" style="text-align:center;padding:5px;">
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="other" class="form-control" placeholder="enter your Othename" required/>
  </div>
...
<div class="col-sm-12 form-group">
  ...
  <label>Class In To Which Applicant Is Seeking Admission:</label>
  

  <select name="intendingclass" class="form-control" required>
...
<option value="KG Class">KG Class</option>
 ...
 <div class="col-sm-12 form-group">
    ...
    <input type="text" name="state" value="" size="30" class="form-control" required/>
 ...
 <div class="form-group form col-sm-4">
  ...
  <div class="col-sm-12 form-group">
      ...
      <textarea type="text" name="residential" row="3" class="form-control" required></textarea> 
    
  </div>
  <div class="col-sm-12 form-group">
      <label>Postal Address:</label>
      <textarea type="text" name="postal" row="3" class="form-control" required></textarea>
...
<div class="form-group form col-sm-4">
  ...
  <div class="col-sm-12 form-group">
    ...
    <input type="text" name="schoolname1" value="" size="30" class="form-control"/>
  </div>
...
<div class=" form-group form col-sm-4">-->
  <div class=" form-group col-sm-12">
    <label>Name Of School</label>
    <input type="text" name="schoolname2" value="" size="30" class="form-control"/>
  </div>
...
<div class="form-group form col-xs-12">
  ...
  <label>Name</label>
  <input type="text" name="parent" value="" size="30" class="form-control" required/>

</div>
<div class="col-sm-7 form-group">
<label>Home Address:</label>
<textarea name="parentaddress"class="form-control"row="3" required></textarea>
...
<div class="form-group form col-xs-12">
  ...
  <input type="text" name="relation" value="" size="30" class="form-control" required/>
   
</div>
<div class="col-sm-3 form-group">
  <label>Occupation:</label>
  <input type="text" name="occupation" value="" size="30" class="form-control" required/>
   
</div>
 <div class="col-sm-3 form-group">
 <label>Tel:</label>
  <input type="text" name="phone" value="" size="30" class="form-control" required/>
  
</div>
<div class="col-sm-3 form-group">
 <label>Child's Health / Complaints:</label>
  <input type="text" name="healthstatus" value="" size="30" class="form-control" required/>
