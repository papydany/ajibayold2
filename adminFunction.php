...
//==========================================================
 function check_admin_user(){
	...
	if(isset($_SESSION['admin_user'])){
		...
		echo'<div class="col-sm-5 col-sm-offset-3 col-md-3 col-md-offset-4">';
...
function add_news_form($news=''){
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label>CONTENT</label>
    <textarea class="form-control" name="news_content" rows="10" cols="20">
  ...
  if($edit){
    echo'
    <input type="hidden" name="oldnews_id" value="'.$news['id'].'"/>';
  }
	  ?>
    
    <div class="col-sm-6">
      <input class="btn btn-success" type="submit" value="<?php echo $edit?'UPDATE':'SUBMIT';?>&nbsp;NEWS"/>
</div></form>
...
function admin_do_url($url,$title){
  ...
  <div  class="admin_achor" style="margin-top:36px;">
   <a class="btn btn-primary btn-xs" href="<?php echo $url; ?>"><?php echo"&nbsp;&nbsp;&nbsp;".$title.'&nbsp;&nbsp;&nbsp;'; ?></a></div>
    <?php
}
?>